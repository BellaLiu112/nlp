...
tokenized_sentence = [preprocess.tokenize(line) for line in train_sentence]
...
tokenized_dev_sentence = [preprocess.tokenize(line) for line in dev_sentence]
...
with PdfPages('smoothing_alpha.pdf') as pdf:
    fig = plt.figure()
    plt.clf()
