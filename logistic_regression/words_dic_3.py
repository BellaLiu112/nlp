...
'''
def generate_matrix(src_file, words_file, labeled):
...
if __name__ == '__main__':
  #generate_words_indices('test.unlabeled.tsv', 'words_indices.txt')
  #words = get_words_indices('words_indices.txt')
  #id, label, matrix = generate_matrix('test.unlabeled.tsv', 'words_indices.txt', False)
  id, label, matrix = generate_matrix('train.tsv', 'words_indices.txt', True)
  print('end')